...
set ::bali::simulation::Para(PROJECT) {try}
set ::bali::simulation::Para(PROJECTPATH) {C:/Users/esi-user/Documents/clock_test}
set ::bali::simulation::Para(FILELIST) {"C:/Users/esi-user/Documents/clock_test/initial_try.v" "C:/Users/esi-user/Documents/clock_test/tb_initial_try.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_initial_try}
